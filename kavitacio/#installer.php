...
".((in_array('jqueryui',$_POST['css-js']))?(''):('; '))."HEAD.CSS[] = 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/themes/base/minified/jquery-ui.min.css'
...
[HEAD - JAVA]
HEAD.JAVA[] = 'http://html5shiv.googlecode.com/svn/trunk/html5.js'
HEAD.JAVA[] = 'http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js'
".((in_array('jqueryui',$_POST['css-js']))?(''):('; '))."HEAD.JAVA[] = 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js'
...
HEAD.JAVA[] = 'http://maps.google.com/maps/api/js?sensor=false' ; Google Maps API
HEAD.JAVA[] = '/js/google-maps.js' ; Google Maps funkció
