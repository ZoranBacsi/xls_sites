...
$_MySQL[$table][] = "
	CREATE TABLE IF NOT EXISTS `".$table."` (
		...
		`gal_cim_it` varchar(255) NOT NULL,
		`gal_cim_ru` varchar(255) NOT NULL,
		`gal_cim_ro` varchar(255) NOT NULL,
		`gal_cim_sk` varchar(255) NOT NULL,
		`gal_cim_jp` varchar(255) NOT NULL,
		`gal_h1` varchar(255) NOT NULL,
		`gal_h1_en` varchar(255) NOT NULL,
		`gal_h1_de` varchar(255) NOT NULL,
		`gal_h1_it` varchar(255) NOT NULL,
		`gal_h1_ru` varchar(255) NOT NULL,
		`gal_h1_ro` varchar(255) NOT NULL,
		`gal_h1_sk` varchar(255) NOT NULL,
		`gal_h1_jp` varchar(255) NOT NULL,
		`gal_title` varchar(255) NOT NULL,
		`gal_title_en` varchar(255) NOT NULL,
		`gal_title_de` varchar(255) NOT NULL,
		`gal_title_it` varchar(255) NOT NULL,
		`gal_title_ru` varchar(255) NOT NULL,
		`gal_title_ro` varchar(255) NOT NULL,
		`gal_title_sk` varchar(255) NOT NULL,
		`gal_title_jp` varchar(255) NOT NULL,
		`gal_keyw` varchar(255) NOT NULL,
		`gal_keyw_en` varchar(255) NOT NULL,
		`gal_keyw_de` varchar(255) NOT NULL,
		`gal_keyw_it` varchar(255) NOT NULL,
		`gal_keyw_ru` varchar(255) NOT NULL,
		`gal_keyw_ro` varchar(255) NOT NULL,
		`gal_keyw_sk` varchar(255) NOT NULL,
		`gal_keyw_jp` varchar(255) NOT NULL,
		`gal_desc` varchar(255) NOT NULL,
		`gal_desc_en` varchar(255) NOT NULL,
		`gal_desc_de` varchar(255) NOT NULL,
		`gal_desc_it` varchar(255) NOT NULL,
		`gal_desc_ru` varchar(255) NOT NULL,
		`gal_desc_ro` varchar(255) NOT NULL,
		`gal_desc_sk` varchar(255) NOT NULL,
		`gal_desc_jp` varchar(255) NOT NULL,
		`gal_text` longtext NOT NULL,
		`gal_text_en` longtext NOT NULL,
		`gal_text_de` longtext NOT NULL,
		`gal_text_it` longtext NOT NULL,
		`gal_text_ru` longtext NOT NULL,
		`gal_text_ro` longtext NOT NULL,
		`gal_text_sk` longtext NOT NULL,
		`gal_text_jp` longtext NOT NULL,
