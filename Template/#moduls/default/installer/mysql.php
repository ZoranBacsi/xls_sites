<?php /* Készítő: H.Tibor */ if(!$_ENV['SiteStart']) { header('HTTP/1.0 404 Not Found',$replace=false,404); header('Location: /'); exit(); }
	...
	$_MySQL[$table][] = "
		CREATE TABLE IF NOT EXISTS `".($table)."` (
			...
			`mod_h1_en` varchar(255) NOT NULL,
			`mod_h1_de` varchar(255) NOT NULL,
			`mod_h1_it` varchar(255) NOT NULL,
			`mod_h1_ru` varchar(255) NOT NULL,
			`mod_h1_ro` varchar(255) NOT NULL,
			`mod_h1_sk` varchar(255) NOT NULL,
			`mod_h1_jp` varchar(255) NOT NULL,
			`mod_title` varchar(255) NOT NULL,
			`mod_title_en` varchar(255) NOT NULL,
			`mod_title_de` varchar(255) NOT NULL,
			`mod_title_it` varchar(255) NOT NULL,
			`mod_title_ru` varchar(255) NOT NULL,
			`mod_title_ro` varchar(255) NOT NULL,
			`mod_title_sk` varchar(255) NOT NULL,
			`mod_title_jp` varchar(255) NOT NULL,
			`mod_keyw` varchar(255) NOT NULL,
			`mod_keyw_en` varchar(255) NOT NULL,
			`mod_keyw_de` varchar(255) NOT NULL,
			`mod_keyw_it` varchar(255) NOT NULL,
			`mod_keyw_ru` varchar(255) NOT NULL,
			`mod_keyw_ro` varchar(255) NOT NULL,
			`mod_keyw_sk` varchar(255) NOT NULL,
			`mod_keyw_jp` varchar(255) NOT NULL,
			`mod_desc` text NOT NULL,
			`mod_desc_en` text NOT NULL,
			`mod_desc_de` text NOT NULL,
			`mod_desc_it` text NOT NULL,
			`mod_desc_ru` text NOT NULL,
			`mod_desc_ro` text NOT NULL,
			`mod_desc_sk` text NOT NULL,
			`mod_desc_jp` text NOT NULL,
			PRIMARY KEY  (`mod_id`),
	...
	$_MySQL[$table][] = "
		CREATE TABLE IF NOT EXISTS `".($table)."` (
			...
			`kep_cimke_jp` varchar(255) NOT NULL,
	...
	$_MySQL[$table][] = "
		CREATE TABLE IF NOT EXISTS `".($table)."` (
			...
			`s_sorsz` int(11) NOT NULL,
			`s_modul` varchar(32) NOT NULL,
			`s_mid` varchar(32) NOT NULL,
			`s_nev` varchar(64) NOT NULL,
			`s_code` varchar(64) NOT NULL,
			`s_width` varchar(8) NOT NULL,
			`s_height` varchar(8) NOT NULL,
			`s_padding` varchar(32) NOT NULL,
			`s_bgimgpos` varchar(32) NOT NULL,
			`s_bgimgrep` varchar(32) NOT NULL,
			`s_bgcolor` varchar(32) NOT NULL,
			`s_fontfamily` varchar(64) NOT NULL,
			`s_fontsize` varchar(8) NOT NULL,
			`s_color` varchar(32) NOT NULL,
	...
	if(!mysqli_num_rows($con)>0) {
		...
		(1, 1, 1, '0', 'root', md5('xlsponthu'), 'A', 'root', 'postmaster@xls.hu', '0612345678', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
		(2, 1, 0, '0', 'admin', md5('admin'), 'A', 'Admin', 'postmaster@xls.hu', '0612345678', '0000-00-00 00:00:00', '0000-00-00 00:00:00');");
		...
		mysqli_query($_ENV['MYSQLI'],'
			...
			( "9998", "def-kepr", "Képek alapértelmezett méretezése", now() ),
			( "9997", "def-html", "HTML Szerkesztő", now() ),
			( "9996", "def-weba", "Weblap Állapota", now() )');
		...
		mysqli_query($_ENV['MYSQLI'],'
			...
			( "def-mail", "Email címe", "sysMailAddress", "postmaster@xls.hu", "mail", "3|64", now() ),
			...
			( "def-html", "Textare széllesége", "sysTextaWidth", "600", "number", "2|4", now() ),
			( "def-html", "Textare magassága", "sysTextaHeight", "400", "number", "2|4", now() ),
			( "def-html", "Kép max széllesége", "sysTextaKepWidth", "600", "number", "2|4", now() ),
			( "def-html", "Kép max magassága", "sysTextaKepHeight", "600", "number", "2|4", now() ),
			( "def-weba", "Fejlesztésalatt", "sysSiteFejlesztes", "Igen", "select", "Igen|Nem", now() ),
			( "def-weba", "Google Analytics ID", "sysGaID", "", "text", "0|32", now() )');
	}
