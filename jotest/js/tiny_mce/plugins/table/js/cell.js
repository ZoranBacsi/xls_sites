...
function init() {
	...
	var align = ed.dom.getAttrib(tdElm, 'align', 'textAlign');
	var valign = ed.dom.getAttrib(tdElm, 'valign', 'verticalAlign');
	...
	if (!ed.dom.hasClass(tdElm, 'mceSelected')) {
		...
		formObj.align.value = align;
		formObj.valign.value = valign;
...
function changedValign() {
	var formObj = document.forms[0];
	var st = ed.dom.parseStyle(formObj.style.value);

	var valign = formObj.valign.value;
		st['vertical-align'] = valign;
