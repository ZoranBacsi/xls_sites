	...
	echo'
		...
		if(count($_ENV['LANG']['ENABLED_LANG'])>1) {
			for($b=0;$b<count($_ENV['LANG']['ENABLED_LANG']);$b++) {
				$_lang = strtolower($_ENV['LANG']['ENABLED_LANG'][$b]);
				if($_lang AND $_lang!='hu') {
					echo'<br/><input type="text" id="mod_h1_'.($sor['mod_id']).'_'.($_lang).'" name="mod_h1_'.($_lang).'['.($sor['mod_id']).']" value="'.($sor['mod_h1_'.($_lang).'']).'" class="typeText" minlength="3" maxlength="60" />';
				}
			}
		}
	echo'
	...
	echo'
		...
		if(count($_ENV['LANG']['ENABLED_LANG'])>1) {
			for($b=0;$b<count($_ENV['LANG']['ENABLED_LANG']);$b++) {
				$_lang = strtolower($_ENV['LANG']['ENABLED_LANG'][$b]);
				if($_lang AND $_lang!='hu') {
					echo'<br/><input type="text" id="mod_title_'.($sor['mod_id']).'_'.($_lang).'" name="mod_title_'.($_lang).'['.($sor['mod_id']).']" value="'.($sor['mod_title_'.($_lang).'']).'" class="typeText" minlength="3" maxlength="60" />';
				}
			}
		}
	echo'
	...
	echo'
		...
		if(count($_ENV['LANG']['ENABLED_LANG'])>1) {
			for($b=0;$b<count($_ENV['LANG']['ENABLED_LANG']);$b++) {
				$_lang = strtolower($_ENV['LANG']['ENABLED_LANG'][$b]);
				if($_lang AND $_lang!='hu') {
					echo'<br/><input type="text" id="mod_keyw_'.($sor['mod_id']).'_'.($_lang).'" name="mod_keyw_'.($_lang).'['.($sor['mod_id']).']" value="'.($sor['mod_keyw_'.($_lang).'']).'" class="typeText" minlength="3" maxlength="60" />';
				}
			}
		}
	echo'
	...
	echo'
		...
		if(count($_ENV['LANG']['ENABLED_LANG'])>1) {
			for($b=0;$b<count($_ENV['LANG']['ENABLED_LANG']);$b++) {
				$_lang = strtolower($_ENV['LANG']['ENABLED_LANG'][$b]);
				if($_lang AND $_lang!='hu') {
					echo'<br/><input type="text" id="mod_desc_'.($sor['mod_id']).'_'.($_lang).'" name="mod_desc_'.($_lang).'['.($sor['mod_id']).']" value="'.($sor['mod_desc_'.($_lang).'']).'" class="typeText" minlength="3" maxlength="60" />';
				}
			}
		}
	echo'
