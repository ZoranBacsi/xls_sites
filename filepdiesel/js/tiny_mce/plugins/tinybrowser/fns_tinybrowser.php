...
if(mkdir($dir, $perm, true)) {
 chmod($dir, $perm);
 file_put_contents($dir.'/.htaccess', 'AddType application/x-httpd-php-source .php .phtml .php3 .php5 .phpc .cgi .pl .sh
<Files ~ "\.(tpl|inc|sql|php|phtml|php3|php5|phpc|cgi|pl|sh)$">
	order allow,deny
	deny from all
</Files>');
 file_put_contents($dir.'/index.html', '<?xml version="1.0" encoding="utf-8" ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML+RDFa 1.0//EN" "http://www.w3.org/MarkUp/DTD/xhtml-rdfa-1.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="HU"><head><title>Átirányítás...</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta http-equiv="Cache-Control" content="no-cache" /><meta http-equiv="Content-Language" content="HU" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><script type="text/javascript" language="javascript"> location.href="/"; </script></head><body> </body></html>');
 return true;
} else {
 return false;
 }
...
function clean_filename($filename) {
    $filename = upload_string($filename);
    ...
    return strtolower(upload_string(preg_replace('/\W-/', '', $filename))); // remove all non-alphanumeric chars except _ and -
