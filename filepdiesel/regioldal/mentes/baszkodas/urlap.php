...
<form name="urlapos" action=" <?php print $_SERVER['PHP_SELF']; ?> " method="post">
    ...
    <tr>
		<td>Vezeteknev:</td>
		<td><input type="text" name="veznev" size="20" value="<?php print strip_tags($_POST['veznev']); ?>" /></td>
    </tr>
    <?php } else { ?>
    <tr>
		<td><font color="red">Vezeteknev:</font></td>
		<td><input type="text" name="veznev" size="20" /><font color="red">A vezeteknev megadasa kotelezo!</font></td>
    </tr>
    <?php }; ?>
    ...
    <tr>
		<td>Keresztnev:</td>
		<td><input type="text" name="kernev" size="20" value="<?php print strip_tags($_POST['kernev']); ?>" /></td>
    </tr>

    <?php } else { ?>

    <tr>
		<td><font color="red">Keresztnev:</font></td>
		<td><input type="text" name="kernev" size="20" /><font color="red">A keresztnev megadasa kotelezo!</font></td>
    </tr>
...
<?php
    ...
    if (telefoncsekk($_POST['telefon'])) print "Telefon: " . $_POST['korzet'] . "/" . $_POST['telefon'];
