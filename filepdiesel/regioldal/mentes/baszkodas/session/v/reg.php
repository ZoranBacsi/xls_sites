...
<?php
	if (isset($_POST['mehet'])) {
		...
		$query = "INSERT INTO passwd VALUES('$felhasznalo', '$jelszo')";
		mysql_query($query, $kapcsolat) or die('Nem tudok írni az adatbázisba...');
		print "Felhasználó hozzáadása sikerült...";
